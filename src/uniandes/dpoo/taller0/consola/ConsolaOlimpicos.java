...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país de atleta por su nombre\n");
    ...
    {
    	System.out.println("\n" + "Pais de atleta por su nombre" + "\n");
    	String stringAtleta = input("Ingrese el nombre del atleta");
        Atleta atleta = calculadora.buscarAtleta(stringAtleta);
        Pais paisAtleta = atleta.darPais();
        String stringPais = paisAtleta.darNombre();
        System.out.println("\n" + "El pais del atleta es: " + stringPais);
    }
	/**
